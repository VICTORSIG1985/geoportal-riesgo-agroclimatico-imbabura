...
export const KB: KBEntry[] = [
  ...
  { category: "Metodología", q: "¿Qué métricas tienen los modelos Random Forest?",
    a: "Validación cruzada espacial k=5 con bloques de 2° latitud (metricas_rf_20260428_202552.csv, Script 06 v1.2.0): Papa AUC=0,871 (σ=0,071), TSS=0,667 (σ=0,139), Kappa=0,630, OOB=0,186. Quinua AUC=0,867 (σ=0,056), TSS=0,625 (σ=0,094), Kappa=0,608, OOB=0,208. Fréjol AUC=0,859 (σ=0,040), TSS=0,583 (σ=0,069), Kappa=0,580, OOB=0,186. Maíz AUC=0,804 (σ=0,067), TSS=0,525 (σ=0,128), Kappa=0,478, OOB=0,252. Los 4 superan los umbrales (AUC≥0,75 Fielding&Bell 1997; TSS≥0,50 Allouche et al. 2006). Métricas de blindaje: AUC-PR 0,637–0,816; MCC 0,509–0,657; F1 0,708–0,814; Brier Score < 0,18 (todos). Brier < 0,20 confirma calibración confiable de probabilidades antes de su ingreso a la Red Bayesiana.",
    tags: ["random forest", "AUC", "TSS", "Kappa", "MCC", "F1", "Brier", "desempeño"] },
